...
它轻量、清晰，并设计为在桌面上保持低调。  
### 如果您喜欢它，请请我喝杯咖啡： [捐赠链接](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)

## Mandarin Chinese (Traditional)
Fancy Clock 是跨平台桌面時鐘，具備指針與數位模式、自動時區本地化，以及包括星空效果在內的多種介面外觀。  
它輕量、清晰，並設計成在桌面上不造成干擾。  
### 如果您喜歡它，請請我喝杯咖啡： [捐贈連結](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Si te gusta, por favor invítame un café: [Enlace de donación](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### यदि आपको यह पसंद आए, तो कृपया मुझे एक कॉफ़ी खरीदें: [दान लिंक](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Si vous l’appréciez, merci de m’offrir un café : [Lien de don](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### যদি এটি আপনার ভালো লাগে, তবে দয়া করে আমাকে একটি কফি কিনে দিন: [দান লিংক](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Se você gostar, por favor me compre um café: [Link de doação](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Если вам нравится, пожалуйста, купите мне кофе: [Ссылка для пожертвования](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)

## Japanese
Fancy Clock はクロスプラットフォーム対応のデスクトップ時計で、アナログとデジタル表示、自動タイムゾーン設定、Starfield を含む複数のスキンに対応しています。  
軽量で見やすく、デスクトップ上で邪魔にならないよう設計されています。  
### 気に入っていただけたら、コーヒーをご馳走してください: [寄付リンク](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Wenn es Ihnen gefällt, kaufen Sie mir bitte einen Kaffee: [Spendenlink](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Yen sampeyan seneng, tulung tukuake aku sak cangkir kopi: [Pranala donasi](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)

## Korean
Fancy Clock 는 아날로그 및 디지털 모드, 자동 시간대 설정, Starfield 를 포함한 여러 스킨을 지원하는 크로스 플랫폼 데스크톱 시계입니다.  
가볍고 명확하며 데스크톱에서 방해되지 않도록 설계되었습니다.  
### 마음에 드신다면 커피 한 잔 사주세요: [기부 링크](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Nếu bạn thích, hãy mua cho tôi một ly cà phê: [Liên kết quyên góp](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Beğendiyseniz lütfen bana bir kahve alın: [Bağış bağlantısı](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Se ti piace, per favore offrimi un caffè: [Link donazione](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Jeśli ci się podoba, proszę postaw mi kawę: [Link do dotacji](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Als je het leuk vindt, trakteer me dan op een kopje koffie: [Donatielink](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### หากคุณชอบมัน โปรดซื้อกาแฟให้ฉันสักแก้ว: [ลิงก์บริจาค](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Om du gillar den, får du gärna bjuda mig på en kaffe: [Donationslänk](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Якщо вам подобається, будь ласка, пригостіть мене кавою: [Посилання для донату](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Dacă îți place, te rog să-mi cumperi o cafea: [Link donație](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
...
### Αν σου αρέσει, σε παρακαλώ αγόρασέ μου έναν καφέ: [Σύνδεσμος δωρεάς](https://www.paypal.com/ncp/payment/7XYN6DCYK24VY)
